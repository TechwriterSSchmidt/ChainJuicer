...
void Oiler::processPump() {
    ...
    // Bleeding Mode: Fast pumping (70ms Pulse / 350ms Pause)
    unsigned long effectivePause = bleedingMode ? 350 : dynamicPauseMs;
    unsigned long effectivePulse = bleedingMode ? 70 : dynamicPulseMs;
