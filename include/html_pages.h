...
<body>
    ...
    <ul>
        ...
        <li><span class='color-box' style='background:magenta'></span> <b>Magenta (pulsing):</b> No GPS Signal (Searching).</li>
        <li><span class='color-box' style='background:orange'></span> <b>Orange (2x short) / Green:</b> 'Emergency Mode' (No GPS > 3 min).</li>
        <li><span class='color-box' style='background:yellow'></span> <b>Yellow (fading):</b> Oiling active.</li>
        <li><span class='color-box' style='border:1px solid #ccc'></span> <b>White (pulsing):</b> 'WiFi Config' Active (Idle).</li>
        <li><span class='color-box' style='background:orangered'></span> <b>Orange (2x blink):</b> 'Tank Warning'.</li>
        <li><span class='color-box' style='background:red'></span> <b>Red (fast blink):</b> 'Bleeding Mode'.</li>
        <li><span class='color-box' style='background:cyan'></span> <b>Cyan (fast blink):</b> Firmware Update in progress.</li>
    </ul>
...
<body>
    ...
    <br>
    <a href='/' class='btn-back'>Back to Config</a>
</body>
</html>
)rawliteral";
